...
class GranjaRaceSpider(scrapy.Spider):
	...
	def start_requests(self):
		urls = [
			#'http://kartodromogranjaviana.com.br/resultados/?flt_ano=%d&flt_mes=%d&flt_dia=%d&flt_tipo=rental' % (now.year, now.month, now.day - 1),
			...
			#'http://kartodromogranjaviana.com.br/resultados/?flt_ano=%d&flt_tipo=rental' % (now.year),
